...
var _excluded = ["radiusTop", "radiusBottom", "height", "bevelSegments", "bevelAmount", "segments", "children"],
  _excluded2 = ["radiusTop", "radiusBottom", "height", "bevelSegments", "bevelAmount", "segments", "children"];
...
var TaperedCylinder = function TaperedCylinder(_ref2) {
  var radiusTop = _ref2.radiusTop,
    radiusBottom = _ref2.radiusBottom,
    height = _ref2.height,
    bevelSegments = _ref2.bevelSegments,
    bevelAmount = _ref2.bevelAmount,
    _ref2$segments = _ref2.segments,
    segments = _ref2$segments === void 0 ? 32 : _ref2$segments,
  ...
  var points = React.useMemo(function () {
    ...
    // Top bevel
    for (var _i2 = 0; _i2 <= bevelSegments; _i2++) {
      var _angle2 = 1.5 * Math.PI + topAngle + bottomAngle * (_i2 / bevelSegments); //1.5PI for 4th quadrant, anticlockwise
      pts.push(new Vector2(adjustedRadiusTop + bevelRadius * Math.cos(_angle2), height * 0.5 - bevelHeight + bevelRadius * Math.sin(_angle2))
      // new Vector2(
